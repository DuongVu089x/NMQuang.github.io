...
public class JDBCSingletonMain {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		JDBCSingleton jdbc = JDBCSingleton.getInstamce();
		...
		do {
	        ...
	        switch(choice) {
		        ...
		        break;
		        case 2: {
		        	System.out.print("Enter the username you want to view data from the database: ");  
                    String username=br.readLine();
                    try {
                    	jdbc.view(username);
                    } catch (Exception e) {
		        ...
		        break;
		        case 4: {
		        	System.out.print("Enter the username you want to update data into the database: ");  
                    String username=br.readLine();  
                    System.out.print("Enter the password you want to update data into the database: ");  
                    String password=br.readLine();  
